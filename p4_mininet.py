...
# [GCC 9.4.0]
# Embedded file name: /home/p4/randomReroute.p4app/p4_mininet.py
# Compiled at: 2022-07-05 13:19:36
...
class P4Switch(Switch):
	...
	def start(self, controllers):
		...
		if not self.check_switch_started(pid):
			error('P4 switch {} did not start correctly. Check the switch log file.\n'.format(self.name))
			exit(1)
